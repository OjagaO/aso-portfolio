        ...
        <div id="w_body" className="box" ref={backImgRef}>
            ...
            <main>
                ...
                <div className="modal-sample">
                        ...
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        北関東学院<br></br>
                                        <a href="https://ojagao.github.io/kitakanto/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                        ...
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        猫カフェ～ごろごろ～<br></br>
                                        <a href="https://ojagao.github.io/catcafe/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                        ...
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        株式会社 Diz<br></br>
                                        <a href="https://ojagao.github.io/Diz/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                        ...
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        Hunter.<br></br>
                                        <a href="https://ojagao.github.io/Hunter/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                        ...
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        Todo List<br></br>
                                        <a href="https://ojagao.github.io/TodoReact/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                        ...
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        NORTH C EAST<br></br>
                                        <a href="https://ojagao.github.io/kitasalon/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                        ...
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        北関堂<br></br>
                                        <a href="https://ojagao.github.io/wagashi/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                        ...
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        北関神社<br></br>
                                        <a href="https://ojagao.github.io/shrine/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                        ...
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        north C east<br></br>
                                        <a href="https://ojagao.github.io/kitasalon2/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                            ...
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        ...
                                        <a href="https://ojagao.github.io/weather/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                            ...
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        ...
                                        <a href="http://program21.wp.xdomain.jp/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                            ...
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        ...
                                        <a href="https://ojagao.github.io/vanillaTodo/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                        ...
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        chat BOT<br></br>
                                        <a href="https://ojagao.github.io/chatbot/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                    ...
                    <div id="animatedModal14" className="all_modal">
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        ポケモン図鑑<br></br>
                                        <a href="https://pokemon-book-7zo024pvq-ojagao.vercel.app/" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                                    ...
                                    <dl>
                                        <dt>◆制作の経緯と流れ</dt>
                                        <dd>Zennの方で情報発信しています。<a href="https://zenn.dev/h_aso/articles/2220c857f5b74c" target="_blank" rel="noreferrer">こちら</a>から記事に飛ぶことができます。</dd>
                                    </dl>
                                    <dl>
                                        <dt>◆こだわり</dt>
                                        <dd>
                                            ...
                                            <br/>ホバーアクションにもポケモン要素を組み込んだ点<br></br>
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆改善点・苦労した点</dt>
                                    ...
                                    <dl>
                                        <dt>◆制作を通してのコメント</dt>
                                        <dd>
                                            あくまでベースはUdemy講座で受講しながら製作したのでベースの制作自体はスムーズにいったが、
                                            自分でアレンジを加えていこうとすると理解度を試されているようでとても良い経験になった。
                                        </dd>
                                    </dl>
                                </div>
                            </div>
                    ...
                    <div id="animatedModal15" className="all_modal">
                        <div className="modal-content">
                            <div className="modal-box">
                                <div className="modal-title">
                                    <h2>
                                        microCMS<br></br>
                                        <a href="https://micro-cms-sample.vercel.app/?vercelToolbarCode=_OYXUjWFliWbvLn" target="_blank" rel="noreferrer">実際のサイトはこちら→</a>
                                    </h2>
                                </div>
                                <div className="modal-info">
                                    <dl>
                                    ...
                                    <dl>
                                        <dt>◆制作の経緯と流れ</dt>
                                        <dd>上記の通り気になったので触ってみて、過去に作成した静的サイトのBlogの部分をheadlessCMS化したのが今回のサイトになります。<br />
                                            Zennの方で情報発信しています。<a href="https://zenn.dev/h_aso/articles/a281a7b4a2d72e" target="_blank" rel="noreferrer">こちら</a>から記事に飛ぶことができます。</dd>
                                    </dl>
                                    <dl>
                                        <dt>◆こだわり</dt>
                                        <dd>
                                            ...
                                            <br/>もっと簡単に更新できるようにしたいというニーズを満たすようなことが可能になった点<br></br>
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>◆改善点・苦労した点</dt>
